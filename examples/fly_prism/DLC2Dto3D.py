...
def main(fly_number,behaviour,video_sequence_number,AniPose_filter_enable=False):
    ...
    for i in range(len(videos_side_LV)):
        ...
        if AniPose_filter_enable==False:
            ...
            np.save('/media/mahdi/LaCie/Mahdi/AniPose/LV/trial_1/pose-2d-filtered/{}_{}_{}_'.format(fly_number, behaviour, video_sequence_number) + 'AniPose_points3d_names_id.npy', name_id_kept_frames)
            np.save('/media/mahdi/LaCie/Mahdi/AniPose/LV/trial_1/pose-2d-filtered/{}_{}_{}_'.format(fly_number, behaviour, video_sequence_number) + 'AniPose_points3d.npy', points3d)
            print('/media/mahdi/LaCie/Mahdi/AniPose/LV/trial_1/pose-2d-filtered/{}_{}_{}_'.format(fly_number, behaviour, video_sequence_number) + 'AniPose_points3d.npy' + ' successfully saved.')
