...
class LinearModel(object):
  ...
  def __init__(self,
    ...
    self.FLY_2D_SIZE = (len(data_utils.OB_LEGS)-len(data_utils.JOINTS_IGNORE)) * 2

    self.FLY_3D_SIZE = (len(data_utils.DF_LEGS)-len(data_utils.JOINTS_IGNORE)) +\
        len(data_utils.DF_COXA_FEMUR)*2
    ...
    with vs.variable_scope( "linear_model" ):
      ...
      if batch_norm:
        #y3 = keras.layers.BatchNormalization(y3,training=self.isTraining,name="batch_normalization")
